 ...
 * 
 */
@WebServiceClient(name = "workWeb", targetNamespace = "http://webservice.cereme.org/", wsdlLocation = "http://localhost:8084/digital-library-webservice/ws/workWs?WSDL")
    ...
    extends Service
{
    ...
    private final static QName WORKWEB_QNAME = new QName("http://webservice.cereme.org/", "workWeb");

    static {
        URL url = null;
        WebServiceException e = null;
        try {
            url = new URL("http://localhost:8084/digital-library-webservice/ws/workWs?WSDL");
    ...
    public WorkWs getWorkWsPort() {
        return super.getPort(new QName("http://webservice.cereme.org/", "workWsPort"), WorkWs.class);
    }
    ...
    public WorkWs getWorkWsPort(WebServiceFeature... features) {
        return super.getPort(new QName("http://webservice.cereme.org/", "workWsPort"), WorkWs.class, features);
    }
